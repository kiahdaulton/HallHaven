...
//        public UsersController(HallHavenContext context)
//        {
//            _context = context;
//        }
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,GenderId,ProfilePicture,ProfileBio,DisplayName,Email,NormalizedEmail,EmailConfirmed,PasswordHash,SecurityStamp,ConcurrencyStamp")] User user)
//        {
//            if (id != user.UserId)
//            {
//                return NotFound();
